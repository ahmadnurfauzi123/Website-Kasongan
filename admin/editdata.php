...
<section id="content">
  ...
  ?>
    ...
    $ambildata= mysqli_query($koneksi,"select * from datakasongan where id='$id'");
    $dtbarang= mysqli_fetch_array($ambildata);
    ?>
<div class="">
 
  <div class="">
    <center><h3>Edit Data kasongan</h3>
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
<form action="editdatakasongan.php" method="post" enctype="multipart/form-data">
...
<tr>
   <td><br>No :</td>
   <td><br><input type="text" value="<?php echo $dtbarang['id']; ?>" placeholder="id" name="id"></td>
  </tr>
  <tr>
   <td><br>file:</td>
     <td> <br> 
  ...
  <tr>
   <td><br>Judul:</td>
<td><br> <input type="text" value="<?php echo $dtbarang['judul']; ?>" placeholder="judul" name="judul"><br/></td>
  </tr>
   <tr>
  <tr>
   <td><br>Penjelasan:</td>
   <td><textarea class="ckeditor" name="penjelasan" rows="5" cols="40" placeholder="isi"><?php echo $dtbarang['penjelasan']; ?></textarea></td>
  </tr>
  <tr>
   <td><br>Detail:</td>
   <td><textarea class="ckeditor" name="detail" rows="5" cols="40" placeholder="isi"><?php echo $dtbarang['detail']; ?></textarea></td>
  </tr>
 
     
 </table><input type="submit" value="Simpan" class="button"><br/>
 <br/>
 </form>
</div>
 <br/>
