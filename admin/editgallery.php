...
<section id="content">
  ...
  ?>
    ...
    $ambildata= mysqli_query($koneksi,"select * from galery where id ='$id'");
    $dtbarang= mysqli_fetch_array($ambildata);
    ?>
  <div class="">
    <center><h3>Edit Data Gallery</h3>
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
<form action="editdatagallery.php" method="post" enctype="multipart/form-data">
...
<tr>
   <td><br><P>No :</td>
   <td><br><P><input type="text" value="<?php echo $dtbarang['id']; ?>" placeholder="id" name="id"></td>
  </tr>
  <tr>
   <td><br><P>file:</td>
     <td> <br> 
              <P><img id="uploadPreview" style="width: 150px; height: 150px;" /><br>  
    <P><input id="uploadImage" type="file" name="fileToUpload" onchange="PreviewImage();" />

<tr>
   <td><br><P>Nama :</td>
   <td><br><P><input type="text" value="<?php echo $dtbarang['nama']; ?>" placeholder="nama" name="nama"></td>
  </tr>
