...
<br>
  ...
  ?> <div class="row-">
    <div class="main">
      <div class="20">
        <div class="grid_5">
          <h1> <a class="logo" href=""><strong>kelola</strong></a> <span>Data</span> </h1>
        </div>
        <div class="grid_5">
...
<table border="2">
  ...
  <?php
    $ambildata=mysqli_query($koneksi,"select * from datakasongan");
    ...
    <tr>
      ...
      <td><?php echo $isi['judul']; ?></td>
                 <td><a href="editdata.php?id=<?php echo $isi['id']; ?>"><img src="images/edit.png" width="15" height="15" align="left"/></a> 
    </tr>
    <?php
    }
  ?>     
